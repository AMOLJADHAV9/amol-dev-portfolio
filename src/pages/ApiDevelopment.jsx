...
const ApiDevelopment = () => {
  ...
  return (
    <>
      <Helmet>
        <title>API Development | Amol Jadhav</title>
        <meta name="description" content="Custom API development services for RESTful and GraphQL architectures. Secure, high-performance, and well-documented APIs built for scalability and seamless integration." />
      </Helmet>
      <ServicePageLayout 
