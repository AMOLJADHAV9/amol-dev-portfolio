...
const UiUxDesign = () => {
  ...
  return (
    <>
      <Helmet>
        <title>UI/UX Design | Amol Jadhav</title>
        <meta name="description" content="Intuitive UI/UX design focusing on user-centric principles, accessibility, and high-fidelity interactive prototypes. Expert in Figma and design systems." />
      </Helmet>
      <ServicePageLayout 
        title="UI/UX Design"
